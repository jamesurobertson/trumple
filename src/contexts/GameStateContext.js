...
import { flipAnimationDelay, flipAnimationDurationMS, wordLength } from "../config";
...
const GameStateContextProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const totalFlipAnimationTimeMS = (wordLength - 1) * flipAnimationDelay + flipAnimationDurationMS;
    const timeout = setTimeout(() => dispatch({ type: "updateKeyboardColors" }), totalFlipAnimationTimeMS);
